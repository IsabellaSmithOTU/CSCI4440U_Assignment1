...
#loading csv 
df = pd.read_csv('../src/logs/eval_ppo_explorer_explorer.csv')
...
plt.ylabel('Reward')
plt.tight_layout()
plt.savefig('learningcurve_ppo_survivor.png')
plt.show()
...
plt.ylabel('Rate')
plt.tight_layout()
plt.savefig('successtrunc_ppo_survivor.png')
plt.show()
...
plt.ylabel('Rate')
plt.tight_layout()
plt.savefig('covgperep_ppo_survivor.png')
plt.show()
