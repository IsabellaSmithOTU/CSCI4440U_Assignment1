...
#loading csv 
df = pd.read_csv('../src/logs/eval_a2c_explorer_explorer.csv')
...
plt.ylabel('Reward')
plt.tight_layout()
plt.savefig('learningcurve_a2c_explorer.png')
plt.show()
...
plt.ylabel('Rate')
plt.tight_layout()
plt.savefig('successtrunc_a2c_explorer.png')
plt.show()
...
plt.ylabel('Rate')
plt.tight_layout()
plt.savefig('covgperep_a2c_explorer.png')
plt.show()
